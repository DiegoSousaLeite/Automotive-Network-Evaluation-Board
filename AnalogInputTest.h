...
private:
    ...
    AnalogInputTest() {
        ...
        tModel = new TestReportModel(JigaTestInterface::ANALOG_INPUT_TEST, JigaTestConstants::ECU1_BOARD_ID);
        ...
        tModel = new TestReportModel(JigaTestInterface::ANALOG_INPUT_TEST, JigaTestConstants::ECU2_BOARD_ID);
        tModel->addIndividualTest(JigaTestConstants::AIN1_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN2_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN3_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN4_INPUT_ITEST);
        ...
        tModel = new TestReportModel(JigaTestInterface::ANALOG_INPUT_TEST, JigaTestConstants::ECU3_BOARD_ID);
        tModel->addIndividualTest(JigaTestConstants::AIN1_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN2_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN3_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN4_INPUT_ITEST);
        ...
        tModel = new TestReportModel(JigaTestInterface::ANALOG_INPUT_TEST, JigaTestConstants::ECU4_BOARD_ID);
        tModel->addIndividualTest(JigaTestConstants::AIN1_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN2_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN3_INPUT_ITEST);
        tModel->addIndividualTest(JigaTestConstants::AIN4_INPUT_ITEST);
