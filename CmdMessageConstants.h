...
public:
    ...
    static constexpr char CMD_HDR_LOOPBACK_CAN[]     ="CANLT:";
    ...
    static constexpr char CMD_HDR_FIND_SERIAL_PORT[] ="SPORT:";
    ...
    static constexpr char CMD_MSG_CAN_INIT[]         ="Teste de inicialização";
    static constexpr char CMD_MSG_LOOPBACK_CAN[]     ="Teste de loopback";
    static constexpr char CMD_MSG_CAN1_NETWORK[]     ="Teste da rede CAN1";
    static constexpr char CMD_MSG_CAN2_NETWORK[]     ="Teste da rede CAN2";
    ...
    static constexpr char CMD_MSG_MCU_INTERFACE[]    ="Teste de inteface da MCU";
};
