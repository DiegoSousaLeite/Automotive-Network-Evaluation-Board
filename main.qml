...
Item {
    width: 1920                              // Largura do Item
    height: 960                              // Altura do Item
    visible: true                            // O Item está visível
    ...
    property int accelerationIncrement: 0       // Incremento de aceleração
...
//            updateConsole();
    ...
    Image {
        ...
        source: "qrc:/assets/DashboardCor.png"
        anchors.margins: 0
